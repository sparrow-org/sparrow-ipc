...
namespace sparrow_ipc
{
    ...
    static const std::vector<sparrow::metadata_pair> metadata_sample = {{"key1", "val1"}, {"key2", "val2"}};
    static const std::optional<std::vector<sparrow::metadata_pair>> metadata_sample_opt = metadata_sample;

    inline void
    test_metadata(const std::vector<sparrow::metadata_pair>& metadata_1, const sparrow::key_value_view& metadata_2)
    {
